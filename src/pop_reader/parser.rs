...
use super::{
    ...
    errors::FIPSParserError, fips_code::SETTING_ID_MASK,
};
...
/// parsed value fits in the `FIPSCode` id field. Unlike many other `parse_*` functions,
...
//       digits is allowed as long as it fits in the setting id field.
fn parse_setting_id(input: &[u8]) -> FIPSParseResult<IdCode> {
    let (rest, value) = parse_integer(input)?;

    if value <= u64::from(SETTING_ID_MASK) {
        ...
        Err((
            ...
            FIPSParserError::ValueExceedsCapacity {
                value_prefix: std::str::from_utf8(&input[..parsed_len])
                    .unwrap()
                    .to_owned(),
                capacity: u64::from(SETTING_ID_MASK),
            },
        ))
    }
}
...
/// `"xprvx"`, if it exists, and verifies that the value fits in the `FIPSCode` id field.
...
/// the value fits in the `FIPSCode` id field.
...
/// value fits in the `FIPSCode` id field.
...
mod tests {
    ...
    fn test_parse_home_id() {
        ...
        // Maximum allowed value (17 bits max = 131071)
        assert_eq!(parse_home_id(b"131071abc"), Ok((&b"abc"[..], 131071)));
        ...
        assert_eq!(
            parse_home_id(b"131072"),
            Err((
                &b"131072"[..],
                FIPSParserError::ValueExceedsCapacity {
                    value_prefix: "131072".to_owned(),
                    capacity: u64::from(SETTING_ID_MASK),
                },
            ))
        );
    ...
    fn test_parse_private_school_id() {
        ...
        // Maximum allowed value (17 bits max = 131071)
        assert_eq!(parse_private_school_id(b"131071"), Ok((&b""[..], 131071)));
        assert_eq!(
            parse_private_school_id(b"xprvx131071"),
            Ok((&b""[..], 131071))
        );
        ...
        assert_eq!(
            parse_private_school_id(b"131072"),
            Err((
                &b"131072"[..],
                FIPSParserError::ValueExceedsCapacity {
                    value_prefix: "131072".to_owned(),
        ...
        assert_eq!(
            parse_private_school_id(b"xprvx131072"),
            Err((
                &b"131072"[..],
                FIPSParserError::ValueExceedsCapacity {
                    value_prefix: "131072".to_owned(),
    ...
    fn test_parse_public_school_id() {
        ...
        // Maximum allowed value (17 bits max = 131071)
        assert_eq!(
            parse_public_school_id(b"131071abc"),
            Ok((&b"abc"[..], 131071))
        );
        ...
        assert_eq!(
            parse_public_school_id(b"131072"),
            Err((
                &b"131072"[..],
                FIPSParserError::ValueExceedsCapacity {
                    value_prefix: "131072".to_owned(),
    ...
    fn test_parse_workplace_id() {
        ...
        // Maximum allowed value (17 bits max = 131071)
        assert_eq!(parse_workplace_id(b"131071abc"), Ok((&b"abc"[..], 131071)));
